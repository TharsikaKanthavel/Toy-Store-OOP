...
<main>
    ...
    <div class="products-grid">
        ...
        <div class="product-card">
            ...
            <img src="https://m.media-amazon.com/images/I/71CRKRGYHCL._AC_UL320_.jpg" alt="Magic Building Blocks" class="product-image">
            <div class="product-info">
                <div class="product-category">Outdoor Fun</div>
                <h3 class="product-name">Large Dart Board for Kids, Kids Dart Board with Sticky Balls, Boys Toys</h3>
                <div class="rating">
                    <div class="stars">
        ...
        <!-- Product 2 -->
        <div class="product-card">
            <img src="https://m.media-amazon.com/images/I/61C9E-oAybL._AC_UL320_.jpg" alt="Adventure Dollhouse" class="product-image">
            <div class="product-info">
                <div class="product-category">Outdoor Fun</div>
                <h3 class="product-name">Rain Showers Splash Pond Toddler Water Table</h3>
                <div class="rating">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
        ...
        <div class="product-card">
            ...
            <img src="https://m.media-amazon.com/images/I/91Je-vPHsfL._AC_UL320_.jpg" alt="Solar System Puzzle" class="product-image">
            <div class="product-info">
                <div class="product-category">Outdoor Fun</div>
                <h3 class="product-name">Animal Bean Bag Toss Game Toy Outdoor Toss Game</h3>
                <div class="rating">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
        ...
        <!-- Product 4 -->
        <div class="product-card">
            <img src="https://m.media-amazon.com/images/I/71XGkqQTtQL._AC_UL320_.jpg" alt="Race Car Track Set" class="product-image">
            <div class="product-info">
                <div class="product-category">Outdoor Fun</div>
                <h3 class="product-name">4-in-1 Dinosaur Water Sprinkler Baseball Toys,360° Spinning Water Play Game</h3>
                <div class="rating">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
        ...
        <!-- Product 5 -->
        <div class="product-card">
            <img src="https://m.media-amazon.com/images/I/7118awKjecL._AC_UL320_.jpg" alt="Cuddly Bear" class="product-image">
            <div class="product-info">
                <div class="product-category">Outdoor Fun</div>
                <h3 class="product-name">for Kids Ages 4-8, Large Kite for Adults, Easy to Fly Beach Kites</h3>
                <div class="rating">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
        ...
        <div class="product-card">
            ...
            <img src="https://m.media-amazon.com/images/I/71Vex+UqD4L._AC_UL320_.jpg" alt="Outdoor Explorer Kit" class="product-image">
            <div class="product-info">
                <div class="product-category">Outdoor Fun</div>
                <h3 class="product-name">3 Pack Airplane Launcher Toys, 13.2'' LED Foam Glider Catapult Plane Toy for Boys, 2 Flight Modes Outdoor Flying Toys</h3>
                <div class="rating">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
    ...
    <div class="pagination">
        <a href="${pageContext.request.contextPath}/product3.jsp">&laquo;</a>
