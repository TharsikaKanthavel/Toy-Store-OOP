...
<main>
  ...
  <div class="products-grid">
    ...
    <div class="product-card">
      ...
      <img src="https://m.media-amazon.com/images/I/71oDm8mrZVL._AC_UL480_FMwebp_QL65_.jpg" alt="Magic Building Blocks" class="product-image">
    ...
    <!-- Product 2 -->
    <div class="product-card">
      <img src="https://m.media-amazon.com/images/I/718uEkuTGQL._AC_UL480_FMwebp_QL65_.jpg" alt="Adventure Dollhouse" class="product-image">
      <div class="product-info">
        <div class="product-category">Building Blocks</div>
        <h3 class="product-name">Building Bricks, Classic Bulk </h3>
        <div class="rating">
          <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="product-card">
      ...
      <img src="https://m.media-amazon.com/images/I/81CFE3mKdlL._AC_UL480_FMwebp_QL65_.jpg  " alt="Solar System Puzzle" class="product-image">
      <div class="product-info">
        <div class="product-category">Building Blocks</div>
        <h3 class="product-name">MEGA BLOKS First Builders Toddler Blocks Toys Set</h3>
        <div class="rating">
          <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <!-- Product 4 -->
    <div class="product-card">
      <img src="https://m.media-amazon.com/images/I/71mnsQS0n1L._AC_UL480_FMwebp_QL65_.jpg" alt="Race Car Track Set" class="product-image">
      <div class="product-info">
        <div class="product-category">Building Blocks</div>
        <h3 class="product-name">Wooden Building Blocks Set </h3>
        <div class="rating">
          <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <!-- Product 5 -->
    <div class="product-card">
      <img src="https://m.media-amazon.com/images/I/81717vG5DHL._AC_UL480_FMwebp_QL65_.jpg" alt="Cuddly Bear" class="product-image">
      <div class="product-info">
        <div class="product-category">Building Blocks</div>
        <h3 class="product-name">Soft Building Block Sets for Kids</h3>
        <div class="rating">
          <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="product-card">
      ...
      <img src="https://m.media-amazon.com/images/I/61Q8Ufn1wfL._AC_UL480_FMwebp_QL65_.jpg" alt="Outdoor Explorer Kit" class="product-image">
      <div class="product-info">
        <div class="product-category">Building Blocks </div>
        <h3 class="product-name">Large Building Foam Blocks for Toddlers</h3>
        <div class="rating">
          <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
  ...
  <div class="pagination">
    <a href="${pageContext.request.contextPath}/product.jsp">&laquo;</a>
    <a href="${pageContext.request.contextPath}/product.jsp" >1</a>
    <a href="${pageContext.request.contextPath}/product1.jsp" class="active">2</a>
    <a href="${pageContext.request.contextPath}/product2.jsp">3</a>

    <a href="${pageContext.request.contextPath}/product2.jsp">&raquo;</a>
  </div>
</main>
